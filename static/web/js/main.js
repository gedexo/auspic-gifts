(function ($) {
  ...
  $('.category-card-slider').slick({
    slidesToShow: 4, // 4 cards in one line for large screens
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 2000,
    speed: 1500,
    ...
    responsive: [
      {
        ...
        settings: {
          slidesToShow: 3, // Show 3 cards for medium-large screens
          arrows: true,
        }
      },
      {
        breakpoint: 991, // For screens smaller than 991px
        settings: {
      ...
      {
        breakpoint: 576, // For screens smaller than 576px (mobile)
        settings: {
          slidesToShow: 1, // Show 1 card per line for mobile
          arrows: false,
        }
      }
    ]
...
// ========================= hot deals Slider Js End ===================
  ...
  //           $( "#amount" ).val( "QAR" + ui.values[ 0 ] + " - $" + ui.values[ 1 ] );
  //       }
  //   });
